...
Процедура ДобавитьЗаписьВПротокол(АвторИзменений, Комментарий) Экспорт
	...
	НоваяСтрока.ВерсияИсправления = ВерсияИсправления;
	НоваяСтрока.СрочностьИсправления = СрочностьИсправления;
...
Процедура ПередЗаписью(Отказ)
	...
	ВерсияИсправленияПоСтрокеПротокола = Справочники.ВерсииПроекта.ПустаяСсылка();
	СрочностьИсправленияПоСтрокеПротокола = Перечисления.СрочностьИсправленияОшибок.ПустаяСсылка();
	...
	Если Протокол.Количество()>0 Тогда
		...
		ВерсияИсправленияПоСтрокеПротокола = СтрокаПротокола.ВерсияИсправления;
		СрочностьИсправленияПоСтрокеПротокола = СтрокаПротокола.СрочностьИсправления;
	...
	Если Статус <> СтатусПоСтрокеПротокола ИЛИ КомуНаправлена <> КомуНаправленаПоСтрокеПротокола
		ИЛИ ВерсияИсправления <> ВерсияИсправленияПоСтрокеПротокола ИЛИ СрочностьИсправления <> СрочностьИсправленияПоСтрокеПротокола Тогда
