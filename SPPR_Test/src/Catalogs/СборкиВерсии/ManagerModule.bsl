...
// Финальная сборка версии.
// 
// Параметры:
//  Версия - Ссылка - Ссылка на версию
// 
// Возвращаемое значение:
//  Неопределено, СправочникСсылка.СборкиВерсии - Финальная сборка версии
Функция ФинальнаяСборкаВерсии(Версия) Экспорт	
	...
	Запрос.УстановитьПараметр("Статус", Перечисления.СтатусыСборокВерсииПроекта.Финальная);
...
Функция СборкиПоПроекту(Параметры) Экспорт
