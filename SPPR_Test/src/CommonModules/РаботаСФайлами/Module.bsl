...
// Загрузить двоичные данные в файлы. // Макаров
// 
// Параметры:
//  ДвоичныеДанные - Двоичные данные
//  ИмяФайла - Строка - Имя файла
//  Расширение - Строка - Расширение файла
//  Владелец - Неопределено, ЛюбаяСсылка - Владелец файла
// 
// Возвращаемое значение:
//  СправочникСсылка.Файлы - Загрузить двоичные данные в файлы
Функция ЗагрузитьДвоичныеДанныеВФайлы(ДвоичныеДанные, ИмяФайла, Расширение, Владелец = Неопределено) Экспорт
	...
	ОписаниеФайла.АдресВременногоХранилищаФайла = АдресВременногоХранилища;
	ОписаниеФайла.ИмяБезРасширения = ИмяФайла;
	ОписаниеФайла.РасширениеБезТочки = ОбщегоНазначенияКлиентСервер.РасширениеБезТочки(Расширение);
	ОписаниеФайла.Размер = ДвоичныеДанные.Размер();
	ОписаниеФайла.ВремяИзменения = ТекущаяДатаСеанса();
	ОписаниеФайла.ВремяИзмененияУниверсальное = УниверсальноеВремя(ТекущаяДатаСеанса());

	СсылкаНаФайл = РаботаСФайламиСлужебныйВызовСервера.СоздатьФайлСВерсией(Владелец, ОписаниеФайла);
